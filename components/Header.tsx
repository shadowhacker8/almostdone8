        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-8 font-heading">
              <Link href="/" className="text-[#313a4b] hover:text-[#0046be] font-medium">Home</Link>
              <button 
              ...
              <Link href="/track" className="text-[#313a4b] hover:text-[#0046be] font-medium">Track Order</Link>
              <Link href="/contact" className="text-[#313a4b] hover:text-[#0046be] font-medium">Contact Us</Link>
            </nav>
