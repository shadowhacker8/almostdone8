        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="hover:text-[#0046be] transition-colors duration-300">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/track" className="hover:text-[#0046be] transition-colors duration-300">
                  Track Order
                </Link>
              </li>
              <li>
                <Link href="/contact" className="hover:text-[#0046be] transition-colors duration-300">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy-policy" className="hover:text-[#0046be] transition-colors duration-300">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:text-[#0046be] transition-colors duration-300">
                  Terms of Service
                </Link>
              </li>
              <li>
                <Link href="/about" className="hover:text-[#0046be] transition-colors duration-300">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/return-policy" className="hover:text-[#0046be] transition-colors duration-300">
                  Refund & Return Policy
                </Link>
              </li>
              <li>
                <Link href="/shipping-policy" className="hover:text-[#0046be] transition-colors duration-300">
                  Shipping Policy
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/cookies" className="hover:text-[#0046be] transition-colors duration-300">
                  Cookies Policy
                </Link>
              </li>
            </ul>
